...
class AGPS{
  ...
  private:
    ...
    void recordGPS(myGPSData *gpsData, Adafruit_GPS *GPS){  //save current data to the structure indicated by the pointer passed
  ...
  public:
    ...
    int initialize(myGPSData *gpsData, Adafruit_GPS *GPS){  //initialize the gps
      GPS->begin(9600);
    ...
    void read(myGPSData *gpsData, Adafruit_GPS *GPS){ //function to read data and save it to the pointer passed
